...
Optional SHAP + risk scores: set CHAMPION_MANIFEST_PATH (and CHAMPION_VARIANT_NAME) and run from repo root.
"""
...
def retrieve():
    ...
    try:
        ...
        if expl is not None:
            response["ml_explanation"] = expl
    except Exception as e:
        response["ml_explanation"] = {"shap_available": False, "shap_error": str(e)}
